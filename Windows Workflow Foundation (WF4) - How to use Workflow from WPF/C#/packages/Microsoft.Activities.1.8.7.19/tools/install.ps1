...
Add-ActivityToolbox -Project $project.Object -Activity "Microsoft.Activities.Statements.LoadActivity" -Category "Microsoft.Activities" -ActivityAssembly "Microsoft.Activities" -BitmapID "Activity"
